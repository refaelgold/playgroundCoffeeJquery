...
#1.inital state of accordion
#2.put click event with h2 click
#3.get the next elment and check if it
#NOTE:u can choose the selected prgraph to show for your will.
#logic:make the slide up and down if the p is visible
accordion = $("#accordion")
headings = $("h2")
paragraphs = $("p")
...
accordion.on "click", "h2", ->
  t = $(this)
  #t para is the pragraph after the H2
  tPara = t.next()
